...
public class DEOService {
    ...
    public boolean addNewProduct(String name, String category, double originalPrice, double salePrice, double priceByUnit, double priceByCarton, int quantity, int vendorId, int branch_id) {
